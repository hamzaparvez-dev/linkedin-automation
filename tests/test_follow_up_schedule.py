...
class TestFollowUpSchedule(unittest.TestCase):
    def test_default_schedule_matches_timeline(self) -> None:
        ...
        self.assertEqual(FOLLOW_UP_SCHEDULE["followup_1"], 3)
        self.assertEqual(FOLLOW_UP_SCHEDULE["followup_2"], 6)
        self.assertEqual(FOLLOW_UP_SCHEDULE["followup_3"], 10)

    def test_eligibility_gaps_derived_from_schedule(self) -> None:
        self.assertEqual(follow_up_eligibility_gaps(), (1, 2, 3, 4))
